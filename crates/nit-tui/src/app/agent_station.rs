...
use nit_core::{
    actions::Action, apply_action, AgentAlert, AgentAlertSeverity, AgentChannel,
    AgentDiagnosticEvent, AgentMessage, AgentOpsTab, AgentStatus, AppState, McpConnectionState,
    MissionPhase, Mode, PaneId, PatchStatus, Prompt, SavedRunHistoryFilter, UiSelection,
...
use crate::{
    ...
    vitals::VitalsState,
    widgets::{agent_console_view, agent_ops_view},
};
