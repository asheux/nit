//! Re-prompts agents whose `observer:repeat_failure` HelpNeeded keeps re-firing.
...
// Mirror of the upstream observer's window. Older HelpNeeded signals are
// already outside the observer's view; counting them here would over-trigger.
